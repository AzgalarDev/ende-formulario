      ...
      <>
        ...
        <Formik
          ...
          validationSchema={Yup.object({
            ...
            secondName: Yup.string().trim()
              .max(15, 'Debe tener 15 caracteres o menos')
              .required('Campo Requerido'), 
            firstSurName: Yup.string().trim()
              .max(20, 'Debe tener 20 caracteres o menos')
              .required('Campo Requerido'),
            secondSurName: Yup.string().trim()
              .max(20, 'Debe tener 20 caracteres o menos')
              .required('Campo Requerido'),
            ...
            repassword: Yup.string()
              .required('No password provided.') 
              .min(8, 'contrasena corta - se aceptan minimo 8 caracteres'),
            documentIdentification: Yup.string()       
              .required('Campo Requerido'),
            typeCity: Yup.string().trim()        
              .required('Campo Requerido'),
            maritialStatus: Yup.string().trim()        
              .required('Campo Requerido'),
            countryOfResidence: Yup.string().trim()
              .required('Campo Requerido'),
            cityOfResidence: Yup.string().trim()
              .required('Campo Requerido'),
            address: Yup.string() 
              .required('Campo Requerido'),   
        ...
        >
          <Form className='form container'>
            ...
            <button type="submit" onClick={() => {console.log("asda")}}>Submit</button>
          </Form>
        </Formik>
      </>
    );
